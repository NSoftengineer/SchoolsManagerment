<!-- Main modal -->
<div id="modal_user" wire:ignore.self data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- <div class="col-span-2">
                            <label for="date_at"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ວັທີ</label>
                            <div class="relative">
                                ...
                                <input datepicker id="defaultdatepicker" type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="ປີ-ດືອນ-ວັນ" datepicker-format="yyyy-mm-dd" wire:model="date_at" />
                            </div>
                            <div>
                                @error('date_at')
                        ...
                        <div class="col-span-2">
                            <label for="name"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ລາຍການ</label>
                        ...
                        <div>
                            <label for="amount"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ຈໍານວນ</label>
                        ...
                        <div>
                            <label for="price"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ລາຄາ</label>
                        ...
                        <div class="col-span-2">
                            <label for="description"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ໝາຍເຫດ</label>
