            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 border-2 border-solid border-[#20518d]">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- <div>
                            <label for="name"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ຊື່
                                ສຳລັບລົງທະບຽນເຂົາໃຊ້ລະບົບ</label>
                        ...
                        <div>
                            <label for="email"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ອີເມວ</label>
                        ...
                        <div>
                            <label for="password"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">ລະຫັດຜ່ານ</label>
