<!-- Main modal -->
<div id="studycost" wire:ignore.self data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    class=" hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-xl max-h-full ">
        <!-- Modal content -->
        <form wire:submit="SaveStudyCost">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 border-2 border-solid border-[#20518d]">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            <label for="yearstudies_id"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                ສົກຮຽນ
                            </label>
                            <select id="yearstudies_id" wire:model="yearstudies_id"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected value="">ເລືອກສົກຮຽນ</option>
                                @foreach ($Yearstudy as $year)
                                    <option value="{{ $year->id }}">{{ $year->name }}</option>
                                @endforeach

                            </select>
                            <div>
                                @error('yearstudies_id')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                        {{ $message }}
                                    </p>
                                @enderror
                        ...
                        <div>
                            <label for="groupitems_id"
                                class="text-base block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                ກູ່ມລາຍການອຸປະກອນເສີມ
                            </label>
                            <select id="groupitems_id" wire:model="groupitems_id"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected>ເລືອກກູ່ມລາຍການອຸປະກອນເສີມ</option>
                        ...
                        <div>
                            ...
                            <div class="flex">
                                <div class="flex items-center me-4">
                                    <input id="inline-radio" type="radio" value="0" name="type_payment"
                                        wire:model="type_payment"
                                ...
                                <div class="flex items-center me-4">
                                    <input id="inline-2-radio" type="radio" value="1" name="type_payment"
                                        wire:model="type_payment"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <div class="flex items-center me-4">
                                    <input checked id="inline-checked-radio" type="radio" value="2"
                                        name="type_payment" wire:model="type_payment"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="inline-checked-radio"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                        ເປັນເດືອນ ແລະ ເປັນພາກຮຽນ
                                    </label>
                                </div>
