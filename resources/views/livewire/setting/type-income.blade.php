<div>
    @include('livewire.setting.modols.type-income-modal')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 ">
        ...
        <div class="grid grid-flow-col justify-items-center md:justify-items-end">
            @can('setting type income create')
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($TypeincomeData as $key => $value)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                ...
                                <td class="px-6 py-4 text-end">
                                    @can('setting type income update')
                                    ...
                                    @endcan
                                    @can('setting type income delete')
...
<script>
    function modalShow() {
        const $targetEl = document.getElementById('typeincome');
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                @this.set('isId', id)
                Livewire.dispatch('deleteTypeIncome');
            }
        })
    }
</script>
