<div>
    @include('livewire.setting.modols.study-years-modal')
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($YearstudyData as $key => $value)
...
<script>
    function modalShow() {
        const $targetEl = document.getElementById('studyyears');
