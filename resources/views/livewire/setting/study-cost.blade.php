<div>
    @include('livewire.setting.modols.study-cost-modal')
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($studyCostData as $key => $value)
                        ...
                        @empty
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                <th scope="row" class="px-6 py-4 text-center" colspan="6">
                                    ບໍ່ມີຂໍ້ມູນ
                                </th>
                            </tr>
                        @endforelse
...
<script>
    function modalShow() {
        const $targetEl = document.getElementById('studycost');
