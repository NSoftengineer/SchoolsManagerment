<div id="form_payment_student" wire:ignore.self data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <form wire:submit="saveCost">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 border-2 border-solid border-[#20518d]">
                ...
                <div
                    ...
                    <button type="button" wire:click="onModalCloseFormPaymentStudent"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="form_payment_student">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <div
                                ...
                                ຈຳນວນທີ່ຕ້ອງຈ່າຍ: {{ number_format($cost) }}
                            </div>
                        </div>
                        <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                            <input id="payment-1" type="radio" value="2" name="payment" wire:model.live="payment"
                ...
                <div
                    ...
                    <div>
                        ...
                        <button wire:click="onModalCloseFormPaymentStudent" type="button"
