<aside id="logo-sidebar"
    class="shadow-sm fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            @if (Auth::user()->can('user'))
                <li>
                    <a href="{{ route('user') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ບັນຊີຜູ້ໃຊ້</span>
                    </a>
                </li>
            @endif
            ...
            @if (Auth::user()->can('personalprofile'))
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">ຂໍ້ມູນສ່ວນບຸກຄົນ</span>
                    ...
                    <ul id="personal-profile" class="hidden py-2 space-y-2">
                        <li>
                ...
                {{-- <li>
                    <a href="{{ route('personal-profile') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ຂໍ້ມູນສ່ວນບຸກຄົນ</span>
            ...
            @if (Auth::user()->can('income'))
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">ບັນຊີລາຍຮັບ</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m1 1 4 4 4-4" />
                ...
                {{-- <li>
                    <a href="{{ route('income') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ບັນຊີລາຍຮັບ</span>
            ...
            @if (Auth::user()->can('expenses'))
                {{-- <li>
                    <a href="{{ route('expenses') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ບັນຊີລາຍຈ່າຍ</span>
                    </a>
                </li> --}}
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="expenses" data-collapse-toggle="expenses">
                        <svg class="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">ບັນຊີລາຍຈ່າຍ</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
            ...
            @if (Auth::user()->can('report'))
                <li>
                    <a href="{{ route('report') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ລາຍງານ</span>
                    </a>
                </li>
            @endif
            ...
            @if (Auth::user()->can('setting'))
                <li>
                    <a href="{{ route('setting') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">ຕັ້ງຄ່າ</span>
                    </a>
                </li>
            @endif
            ...
            {{-- <li>
                ...
                <a href="{{ route('logout') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">ອອກຈາກລະບົບ</span>
                </a>
            </li> --}}
        </ul>
        <div class='fixed bottom-0 w-full'>
            <a href="{{ route('logout') }}"
                class='flex items-center bottom-0 w-[55%] md:w-[90%] my-8 px-5 py-2 bg-red-500 text-white text-sm font-bold tracking-wide rounded focus:outline-none'>
